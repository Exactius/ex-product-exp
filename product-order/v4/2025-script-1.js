(function () {
  ...
  const pwShortArray = [
    ...
    ['water line and sewer line protection program', 'water line and sewer line insurance policy'],
    ['water line, sewer line and in-home plumbing emergency program'],
    ['unlimited water line protection program', 'unlimited water line insurance policy'], 
    ['unlimited sewer line protection program', 'unlimited sewer line insurance policy'], 
    ['unlimited water line and sewer line protection program', 'unlimited water line and sewer line insurance policy'], 
    ['in-home plumbing emergency program', 'in-home plumbing plus program'], 
    ['interior electric line protection program', 'interior electric line insurance policy'], 
    ['exterior electric line protection program', 'exterior electric line insurance policy'], 
  ...
  const phillyShortArray = [
    ...
    ['unlimited sewer line protection program', 'unlimited sewer line insurance policy'], 
    ['unlimited water line and sewer line protection program', 'unlimited water line and sewer line insurance policy'], 
    ['energy essentials protection program', 'energy essentials insurance policy'], 
    ['in-home plumbing clog protection program', 'in-home plumbing clog insurance policy'],
    ...
    const productsCheck = setInterval(async function () {
      ...
      if (products.length != 0) {
        ...
        for await (product of products) {
          ...
          let productIcon = await jQuery(product).find('.product-icon').attr('src');
          ...
          if (
            shortArray.find((val) => val.includes(name.toLowerCase()))
          ) {
