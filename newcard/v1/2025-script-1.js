  ...
  function createTest() {
    ...
    const productsCheck = setInterval(async function () {
      if (jQuery(".page-wrap.product-list .product-item .card").length != 0) {
        ...
        jQuery("header").after(
          `<div class="products-wrapper"><div class="products-inner"><div class="products-title"><h2>We&apos;ve got your back</h2></div><p class="product-description">The following plans are available in</p> 
                    ...
                    <div data-targettitle="${value.target}" class="products-single-box product-card-spz ${value.productClass} ${value.popularItem} ${value.bestProductItem} product-card-${index}">
                        ...
                        <div class="product-title">
                            ...
                            <div class="product-cart-info">
                                ...
                                <p class="terms">See <a href="https://www.awrusa.com/terms" target="_blank">Terms and Conditions</a></p>
                                </div></div>
                                    `);
        });
