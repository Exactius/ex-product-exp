window.bioEp = {
  ...
  checkCookie: function () {
    ...
    if (this.cookieExp <= 0) {
      ...
      if (
        ...
        this.cookieManager.get("bioep_shown_session") == "true"
      )
        return true;
  ...
  addCSS: function () {
    ...
    var css = document.createTextNode(
      "#bio_ep_bg {display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: #000; opacity: 0.3; z-index: 10001;}" +
        "#bio_ep {display: none; position: fixed; width: " +
        this.width +
        "px; height: " +
        this.height +
  ...
  scalePopup: function () {
    ...
    if (this.transformDefault === "")
      this.transformDefault = window
        .getComputedStyle(this.popupEl, null)
        .getPropertyValue("transform");

    // Apply the scale transformation
    this.popupEl.style.transform =
      this.transformDefault + " scale(" + scaleTo + ")";
  },
  ...
  setOptions: function (opts) {
    ...
    this.height =
      typeof opts.height === "undefined" ? this.height : opts.height;
    ...
    this.showOncePerSession =
      typeof opts.showOncePerSession === "undefined"
        ? this.showOncePerSession
        : opts.showOncePerSession;
    this.onPopup =
      typeof opts.onPopup === "undefined" ? this.onPopup : opts.onPopup;
  },
