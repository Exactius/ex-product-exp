  ...
  function createTest(url) {
    ...
    const productsCheck = setInterval(async function () {
      ...
      if (products.length != 0) {
        ...
        let filterCardValueArr = ["wholeHome", "wsp", "hvac", "eg", "other"];
            ...
            ${filterCardsArr
              .map((card, index) => {
                ...
                <label for="filter-card${
                  index + 1
                }" class="filter-card filter-card-${
                  index + 1
                } b-contain active-card">
        ...
        $(".filter-cards-wrapper input").prop("checked", true);
                ...
                ${data
                  ...
                  ${
                    ...
                    `
                      : `
                      ${
                        prod.bestProductItem && prod.bestProductItem.length > 0
                          ? `
                        <div class="most-populer">
                          <p>Best Value Plan</p>
                        </div>
                  ...
                  <div class="products-card-checkout ${
                    ...
                    <div class="products-card-coverage">
                      ...
                      ${
                        Object.keys(prod.covered).map((i) => i).length > 2
                          ? `<div class="wrapper-list">
                        <button id="btn-view-${prod.index}" class="card-coverage-btn">
                          <img class="see-view-arrow" src="${imgBaseUrl}/left_arrow.svg" alt="" />
                          <sapn class="pl-3">View all coverage</sapn>
                        </button>
                        <button id="btn-less-${prod.index}" class="hidden-btn card-coverage-less">
                          <img class="see-less-arrow" src="${imgBaseUrl}/left_arrow.svg" alt="" />
                          <sapn class="pl-3">See less coverage</sapn>
                        </button>
                      </div>`
                          : ""
                      }
              ...
              <div class="swiper">
                ...
                ${data
                  ...
                  <div class="products-card-checkout ${
                    ...
                    <div class="products-card-coverage">
                      <ul class="covered-repairs-list scrolbar covered-repairs-list${
                       ...
                       ${
                         Object.keys(prod.covered).map((i) => i).length > 2
                           ? `<div class="wrapper-list">
                        <button id="btn-mobile-view-${prod.index}" class="card-coverage-btn">
                          <img class="see-view-arrow" src="${imgBaseUrl}/left_arrow.svg" alt="" />
                          <sapn class="pl-3">View all coverage</sapn>
                        </button>
                        <button id="btn-mobile-less-${prod.index}" class="hidden-btn card-coverage-less">
                          <img class="see-less-arrow" src="${imgBaseUrl}/left_arrow.svg" alt="" />
                          <sapn class="pl-3">See less coverage</sapn>
                        </button>
                      </div>`
                    ...
                    <button id="btn-learn-more-${
                      prod.index
                    }" class="learn-plan ga-track-learn-more">
                      <h3>Learn Why Homeowners Buy This Plan</h3>
                    </button>
                    <div class="products-card-pay-amount">
                      <div class="products-card-pay">
          ...
          $(".btn-checkout").click((e) => {
            btnEnrollNowSorted.map((i, idx) => {
              ...
              if (
                ...
                btnEnrollNowSorted[idx].enrollNowBtn.click();
              }
            });
          });
                ...
                data.map((prod) => {
                  if (coveredId === `${prod.index}`) {
                    ...
                    if (window.innerWidth < 1024) {
                      $(`#btn-mobile-less-${prod.index}`).removeClass(
                        "hidden-btn"
                      );
                    } else {
                      $(`#btn-less-${prod.index}`).removeClass("hidden-btn");
                    }
                  }
                });
              }
                  ...
                  if (coveredId === `${prod.index}`) {
                    ...
                    $(`.covered-repairs-list${coveredId}`).append(`
                      ${Object.keys(prod.covered)
                        ...
                        `);
                    if (window.innerWidth < 1024) {
                      $(`#btn-mobile-view-${prod.index}`).show();
                    } else {
                      $(`#btn-view-${prod.index}`).show();
                    }
                    $(`#${e.currentTarget.id}`).addClass("hidden-btn");
                  }
                });
              }
            });
          ...
          $(".learn-plan").click((e) => {
            btnlearnMoreSorted.map((i) => {
              ...
              if (
                ...
                dataLayer.push({ event: "learn_more" });
                setTimeout(() => {
        ...
        let btnEnrollNowSorted = [];
        let btnlearnMoreSorted = [];
        ...
        sortedProducts.forEach((item) => {
          ...
          if (
            ...
            productName.includes("home comfort") ||
        ...
        const handleChange = async (e, index) => {
          ...
          if (filterCardValueArr.length > 0) {
            prodListHtmlOld.show();
            $(".not-found-prods").remove();
            ...
            prodListHtmlOld.hide();
            $(".header-wrapper").append(
              `<p style="text-align:center;padding-top:48px;padding-bottom:20px;" class='not-found-prods'>Please Select Category</p>`
            );
          }
